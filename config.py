...
bot_token = "7928239115:AAFqP75FKKIfnhO629kJs-P5yc8Ul5fEQqc" #botfatherdan alabilirsiniz

client = TelegramClient("Samil", api_id, api_hash).start(bot_token=bot_token)

USERNAME = "Dogunun_efsanesi_tag_bot" #botunuzun kullanıcı adı 
...
support = "https://t.me/affetmezler_sohbet" #destek qrupunuzun kullanıcı adı
