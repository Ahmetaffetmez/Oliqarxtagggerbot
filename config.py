...
bot_token = "7639533167:AAGqjd-Gh6Yk5tSwGsFyX68a5J2hxFVe5oI" #botfatherdan alabilirsiniz

client = TelegramClient("Samil", api_id, api_hash).start(bot_token=bot_token)

USERNAME = "Kurtlar_sofrasi_tag_bot" #botunuzun kullanıcı adı 
...
support = "https://t.me/kurtlar_sofrasi_oyun" #destek qrupunuzun kullanıcı adı
sahib = "kurucu_sahip" #sahibinizin kullanıcı adı
