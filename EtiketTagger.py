    ...
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [
                       ...
                       Button.url('👨‍💻  Sahip  ', f'https://t.me/kasapAlp')], #sahibin telegram profil linki
    ...
    async for usr in client.iter_participants(event.chat_id):
     ...
     await event.edit(f"{ad} {startmesaj}", buttons=(
                      [
                       Button.url('🎉  beni gruba davet et 🎉', f'https://t.me/{USERNAME}?startgroup=a')],
                      [Button.url("📚  komutlar ", f'https://t.me/sohbetveoyuntr'), #komutların olduğu kanal
                       Button.url('👨‍💻  Sahib  ', f'https://t.me/kasapAlp')] #sahibin telegram profil linki
                       [Button.url('📝  Kanal  ', f'https://t.me/sohbetveoyuntr')] #Kanalın destek grubu vs
                    ),
                    link_preview=False)
...
async def handler(event):
    await event.edit(f"{komutlar}", buttons=(
                      ...
                      Button.url('📣 SAHİP ', f'https://t.me/kasapAlp') #sahibin telegram profil linki
                      ],
                      [
