  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [
                       Button.url('📚  komutlar ', f'https://t.me/titanicbio'), #komutların olduğu kanal
                       Button.url('👨‍💻  Sahip  ', f'https://t.me/kurucu_sahipp')], #sahibin telegram profil linki
                       [Button.url('📝  Kanal  ', f'https://t.me/titanicbio')] #Kanalın destek grubu vs
                    ),
                    link_preview=False)
...
async def handler(event):
    await event.edit(f"{komutlar}", buttons=(
                      [
                      Button.url('📣 Sohbet grubu  ', f'https://t.me/titanicbio'), #destek grubun linki
...
async def mentionall(event):
  ...
  if mode == "text_on_cmd":
    await client.send_message(event.chat_id, " 📢 üyeleri etiketleme işlemi başladı . . .",
                    buttons=(
                      [
                      Button.url('📝  𝖪ANAL  📝', f'https://t.me/titanicbio')
                      ]
                    )
                  ) 
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in etiket_tagger:
        await event.respond("⛔ üyeleri etiketleme işlemi durduruldu . . .",
                    buttons=(
                      [
                       Button.url('📝  KANAL  📝', f'https://t.me/titanicbio')
                      ]
                    )
                  )
        return
